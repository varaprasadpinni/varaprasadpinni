...
//         try {
//             const response = await fetch(` http://localhost:3000/properties/${listingId}`,{
//                 method: 'GET',
//             })
...
//                 <img src={`http://localhost:3000/${item.replace("public","")}`} alt="listing photos"/>
//             ))}

//         </div>
//         <h2>{listing.type} in {listing.city},{listing.province}, {listing.country}</h2>

//         <p>{listing.guestCount} guests - {listing.bedCount} bed(s) - {listing.bathroomCount} bathroom(s)</p>

//         <hr />

//         <div className='profile'>
//             <img src={`http://localhost:3000/${listing.creator.profileImagePath.replace("public","")}`}/>
